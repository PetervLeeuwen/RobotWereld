 ...
 *
 */
WayPointShape::WayPointShape( WayPointPtr aWayPoint) :
				RectangleShape( std::dynamic_pointer_cast<ModelObject>(aWayPoint),aWayPoint->getPosition(), aWayPoint->getName())
{
}
/**
 *
 ...
 *
 */
void WayPointShape::setWayPoint( WayPointPtr aWayPoint)
{
	setModelObject(std::dynamic_pointer_cast<ModelObject>(aWayPoint));
}
