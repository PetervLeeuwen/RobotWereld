										...
										int aFreeRadius /*= 1*/)
{
	...
	for (int i = 0; i < 8; ++i)
	{
		...
		{
			if (Shape2DUtils::isOnLine( wall->getPoint1(), wall->getPoint2(), vertex.asPoint(), aFreeRadius))
			{
										...
										const Size& aRobotSize)
{
	...
	std::vector< Vertex > path = AStar::search( start, goal, aRobotSize);
	return path;
}
/**
 *
...
//			Duration: 17349490 openSet: 1507 closedSet: 76521 predecessorMap: 78027
//
//			After the insert of all:
//			aRobotSize = (37,29), radius = 23
//			Duration: 7733159 openSet: 1507 closedSet: 76521 predecessorMap: 78027
//
//			Partial sort after insert of all:
//			aRobotSize = (37,29), radius = 23
//			Duration: 3297669 openSet: 1507 closedSet: 76521 predecessorMap: 78027
//
//			No sorting, just iterator swap for begin() and the minimum element, which is basically
//			the smallest partial_sort there is...
//			aRobotSize = (37,29), radius = 23
//			Duration: 2626220 openSet: 1507 closedSet: 76521 predecessorMap: 78027
//
