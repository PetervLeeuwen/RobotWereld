...
class Shape : public ViewObject
{
	public:
		 ...
		 *
		 */
		Shape(ModelObjectPtr aModelObject) :
		...
		/**
		 * This function is called by the RobotWorldCanvas when the use starts dragging this object.
		 */
		virtual void handleBeginLeftDrag()
		{
		}
		/**
		 * This function is called by the RobotWorldCanvas when the use drops this object after dragging.
		 */
