...
/**
 * The ObjectId class is also used in Dagda. Therefor it has the required
...
class ObjectId : public std::vector< unsigned char >
{
	public:
		 ...
		 * is generated in. If multiple application use the same library it is the responsiblity of
		 ...
		 * 				  	Is actually ignored and alway true.
		 */
		ObjectId( 	unsigned long /*max*/,
					unsigned long len,
		...
		/**
		 *
		 * @return The curretn lenth of the ObjectId
		 */
		 ...
		 *
		 */
		ObjectId( const char* anObjectIdString) :
						base( anObjectIdString, anObjectIdString + std::strlen( anObjectIdString))
		{
		}
		/**
		 *
